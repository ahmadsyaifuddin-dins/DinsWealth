        ...
        @else
            <div class="text-center py-12 md:py-16">
                <div
                    ...
                    <svg class="w-10 h-10 md:w-12 md:h-12 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <h3 class="text-lg md:text-xl font-medium text-gray-900 dark:text-gray-100 mb-2">Belum ada data tabungan</h3>
                <p class="text-gray-500 dark:text-gray-400 mb-4 md:mb-6 text-sm md:text-base px-4">Mulai dengan menambah transaksi
                    pertama Anda</p>
                <button

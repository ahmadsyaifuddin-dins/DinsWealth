                    ...
                    <div class="p-4 md:p-8">
                        ...
                        @else
                            <div class="text-center py-12 md:py-16">
                                ...
                                <p class="text-gray-500 mb-4 md:mb-6 text-sm md:text-base px-4">Mulai dengan menambah transaksi pertama Anda</p>
                                <button
                    ...
                    <div class="p-4 md:p-8">
                        ...
                        @empty
                            <div class="text-center py-12 md:py-16">
                                ...
                                <p class="text-gray-500 text-sm md:text-base px-4">Data tabungan akan muncul di sini ketika tersedia</p>
                            </div>
                        @endforelse
                    </div>
                </div>
